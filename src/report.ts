...
<body><a class="skip" href="#report">Skip to report</a><header><div class="brand"><i></i> TICKLENS / ROOM REPORT</div><div>${escapeHtml(trace.serverName ?? "Local trace")}</div></header>
<main id="report"><p class="eyebrow">Multiplayer update report · ${escapeHtml(new Date(trace.generatedAt).toLocaleString("en"))}</p>
